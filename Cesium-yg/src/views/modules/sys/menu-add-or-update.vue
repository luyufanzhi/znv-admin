  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <el-form-item v-if="dataForm.type !== 2" label="菜单图标" prop="icon">
       ...
       <el-form-item label="终端类型" prop="agent">
        <el-radio-group v-model="dataForm.agent">
          <el-radio v-for="(type, index) in dataForm.atentList" :label="index" :key="index">{{ type }}</el-radio>
        </el-radio-group>
      </el-form-item>
    </el-form>
        ...
        this.$http({
          ...
          if (!this.dataForm.id) {
            ...
            this.$http({
              ...
              this.dataForm.agent = data.menu.agent;
              this.menuListTreeSetCurrentNode()
            })
          }
        })
