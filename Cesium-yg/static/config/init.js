...
;(function () {
  var resList = {
    ...
    css: [
      ...
      window.SITE_CONFIG.cdnUrl + '/static/plugins/Cesium/Cesium/Widgets/widgets.css',
    ],
    js: [
      ...
      window.SITE_CONFIG.cdnUrl + '/static/plugins/Cesium/Cesium/Cesium.js',
      window.SITE_CONFIG.cdnUrl + '/static/plugins/Cesium/supermap/SuperMap.Include.js',
      window.SITE_CONFIG.cdnUrl + '/static/plugins/Cesium/config.js',
      window.SITE_CONFIG.cdnUrl + '/static/plugins/Cesium/Cesium/Cesium.js'
    ]
  };
