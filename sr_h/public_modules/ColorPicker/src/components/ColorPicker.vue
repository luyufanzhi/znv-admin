<template>
    ...
    <div class="colorPicker">
        <div class="picker" ref="picker">
            ...
            <!-- 遮罩图片 -->
            <img class="img" src="../../static/images/image_lamp_circular.png" ref="img" alt="load error">
...
export default {
    ...
    methods: {
        ...
        getTop( el ){
            ...
            this.deviceLog( 'offsetParennt', typeof el.offsetParent );
            this.deviceLog( 'getBoundingClientRect', typeof el.getBoundingClientRect );
            this.deviceLog( 'getTop', offset );
            return offset;
        },
        /**
         * 获取页面 left 值
        ...
        setCircleTopLeft( res ) {
            let circle = [ res.x + this.circleR, res.y + this.circleR ];
            this.deviceLog( 'canavsXY', circle );
            this.setStyle( this.$refs.circle, {
